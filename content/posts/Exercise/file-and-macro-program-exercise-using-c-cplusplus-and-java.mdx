...
2. Write a C program to test whether a character entered is a upper case letter or not using macro definition.
3. Write a C program to test whether a character is an alphabet or not using macro definition.
4. Write a C program to obtain the bigger of two numbers using macro definition.
5. Write a C program to find arithmetic mean of two numbers.
6. Write a C program to find absolute value of a number.
7. Write a C program to convert a uppercase alphabet to lowercase.
