...
- A variable is an [identifier](https://funycode.com/identifier-set-in-c/) that is used to represent some specified type of information within a designated portion of the program.
