...
- Floating point numbers are defined in C by the [keyword](https://funycode.com/token-in-c/) float. When the accuracy provided by a float number is not sufficient,
...
- This is usually used to specify the type of [functions](https://funycode.com/function-in-c/).
