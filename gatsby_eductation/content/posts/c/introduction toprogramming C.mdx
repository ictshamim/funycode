...
- It is a robust language whose rich set of built-in [functions](https://funycode.com/function-in-c/) and [operators](https://funycode.com/operator-in-c/) can be used to write any complex program.
...
- There are only 32 [keywords](https://funycode.com/token-in-c/) in [ANSI C](https://en.wikipedia.org/wiki/ANSI_C) and its strength lies in its built-in functions. Several standard functions
