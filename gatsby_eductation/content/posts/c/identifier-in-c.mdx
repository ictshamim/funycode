...
An identifier is a sequence of characters that represents a name for the [variable](https://funycode.com/variable-in-c/), [function](https://funycode.com/function-in-c/), label, type definition,structure, enumeration,
...
- The underscore character is also permitted in identifiers. It is usually used as a link between two words in long [identifiers](https://funycode.com/identifier-set-in-c/).
