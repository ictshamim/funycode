---
title: Write a C/C++/Java program to read any Month Number in integer and display the number of days for this month.
...
## C Implementation
### Program-25: Write a program in C to read any Month Number in integer and display the number of days for this month.
```c
...
## Java Implementation
### Program-25: Write a program in java to read any Month Number in integer and display the number of days for this month.
```js
